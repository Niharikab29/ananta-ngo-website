...
const AboutSection = () => {
  ...
  return <section ref={sectionRef} className="relative min-h-[300vh] bg-background">
      ...
      <div ref={imageRef} className={`fixed top-0 left-0 w-full lg:w-[40%] h-screen bg-[#FBFAF5] transition-all duration-1000 overflow-hidden ${isVisible ? "scale-105" : "scale-100"}`}>
      ...
      <div ref={contentRef} className="relative lg:ml-[40%] bg-secondary min-h-[300vh]">
          ...
          <div className="w-full px-6 lg:px-12 py-12 lg:py-0">
            <div className="max-w-2xl space-y-16">
              ...
              <div></div>}
                  ...
                  {block.type === "quote" && <blockquote className="text-xl lg:text-2xl font-light text-foreground italic border-l-4 border-primary pl-6">
                      {block.content}
                    </blockquote>}
                  
                  {block.type === "vision" && <div className="space-y-4">
                      <div className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-full text-sm font-cabinet font-medium">
                        {block.label}
                      </div>
                  ...
                  {block.type === "mission" && <div className="space-y-6">
                      <h3 className="font-cabinet text-2xl font-light text-foreground tracking-wide">
                        {block.label}
                      </h3>
                  ...
                  {block.type === "values" && <div className="space-y-8">
                    ...
                    transitionDelay: `${index * 100 + idx * 200}ms`
                            ...
                            <div className="space-y-1">
                              <h4 className="font-cabinet text-lg font-medium text-foreground">
                                {value.title}
                              </h4>
